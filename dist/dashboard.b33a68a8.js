...
})({"63cR9":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "6b0f60d4b33a68a8";
"use strict";
...
},{}],"9Lptz":[function(require,module,exports,__globalThis) {
...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    (0, _netlifyIdentityWidgetDefault.default).on('login', ()=>syncProfileState());
    (0, _netlifyIdentityWidgetDefault.default).on('logout', ()=>syncProfileState());
    syncProfileState();
});
...
async function loadEnrolledTracks() {
    try {
        ...
        console.error(error);
        if (enrollmentContainer) enrollmentContainer.innerHTML = `<p class="grid-message">Failed to process profile data stream rules.</p>`;
    }
}
...
},{"netlify-identity-widget":"aE0Xm","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["63cR9","9Lptz"], "9Lptz", "parcelRequirefc40", {})

//# sourceMappingURL=dashboard.b33a68a8.js.map
